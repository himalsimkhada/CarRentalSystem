                ...
                <div class="card-body">
                    @if (auth()->user()->user_type == 3)
                        ...
                        @forelse($notifications as $notification)
                            @if ($notification->type == 'App\Notifications\NewReservationNotificationCurUser')
                            ...
                            @elseif ($notification->type == 'App\Notifications\NewPaymentNotificationCurUser')
                            ...
                            @elseif ($notification->type == 'App\Notifications\NewPartnerRequestNotification')
                                <div class="alert alert-primary" role="alert">
