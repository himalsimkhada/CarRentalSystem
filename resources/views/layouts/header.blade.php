                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto py-4 py-md-0">
                            ...
                            <li
                                class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 {{ request()->is('car*') ? 'active' : '' }}">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @foreach ($getDetails as $detail)
                                        <a class="dropdown-item" href="{{ route('car.category', ['type_id' => $detail->id]) }}">{{ $detail->name }}</a>
                                    @endforeach
                                </div>
                            </li>
                            ...
                            @else
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                        ...
                                        {{ Auth::user()->username }} <i class="fas fa-caret-down"></i></a>
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('logout') }}"
                                            ...
                                            {{ __('Logout') }}<span class="material-icons align-middle float-right">
                                                logout
                                            </span>
                                        </a>
