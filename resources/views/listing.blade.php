            ...
            <form action="{{ route('listing') }}" method="get" class="p-5 needs-validation" novalidate>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="date" name="picking-date" value="{{ $pickdate }}" min="{{ date('Y-m-d') }}" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dropping-date" value="{{ $dropdate }}" id="" class="form-control" min="{{ date('Y-m-d') }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select name="picklocation" class="custom-select" required>
                            ...
                            @foreach ($locations as $location_all)
                                <option value="{{ $location_all->location }}">{{ $location_all->location }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                ...
                @foreach ($list as $lists)
                    <div class="col-sm-3 my-5">
                        <div class="card" style="width: 100%; min-height: 100%">
                            <img src="{{ file_exists(asset('images/car/images/' . $lists->primary_image)) ? asset('images/car/images/' . $lists->primary_image) : asset('images/car/images/default.png') }}" class="card-img-top" alt="...">
                            <div class="card-body">
