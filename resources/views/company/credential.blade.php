                    ...
                    <div class="modal fade" id="addCredential" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('company.store.credential') }}" method="post"
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <div class="btn-group float-right">
                                                        ...
                                                        <div class="modal fade" id="{{ $credential->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('company.update.credential', ['id' => $credential->id]) }}"
                                                        ...
                                                        <a href="{{ route('company.delete.credential', ['id' => $credential->id]) }}"
