...
@section('content')
    ...
    <form action="@if (\Auth::check()) {{ route('contactus.post', ['id' => auth()->user()->id]) }} @else {{ route('contactus.post') }} @endif" method="post" class="needs-validation" novalidate>
        @csrf
                    ...
                    <div class="contact-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $details->firstname . ' ' . $details->lastname }}" id="fname"
                        ...
                        @if (\Auth::check())
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="email" value="{{ $details->email }}"
                        ...
                        @if (\Auth::check())
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="contact">Contact Num:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="contact" value="{{ $details->contact }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" name="type" id="" required>
