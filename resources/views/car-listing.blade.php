...
@section('content')
        ...
        <li class="list-inline-item">
            <div class="dropdown open drop-left">
                ...
                <div class="dropdown-menu" aria-labelledby="triggerId">
                    <a class="dropdown-item" href="{{ route('cars.list') }}">All</a>
                    <a class="dropdown-item" href="{{ route('car.list.pricedesc') }}">Price High to Low</a>
                    <a class="dropdown-item" href="{{ route('car.list.priceasc') }}">Price Low to High</a>
                </div>
            </div>
        </li>
        <li class="list-inline-item">
            <form action="{{ route('car.list.location') }}" method="post" class="form-inline needs-validation" novalidate>
                @csrf
    ...
    @if (\Route::current()->getName() == 'car.list.pricedesc')
    ...
    @elseif (\Route::current()->getName() == 'car.list.priceasc')
        <div class="row p-0 m-0">
            <div class="col col-12">
                <p class="text-center h1 mt-5 align-middle">List of the available rental cars</p>
                <div class="row cont-row">
    ...
    @elseif (\Route::current()->getName() == 'car.list.location')
        <div class="row p-0 m-0">
            <div class="col col-12">
                <p class="text-center h1 mt-5 align-middle">List of the available rental cars</p>
                <div class="row cont-row">
